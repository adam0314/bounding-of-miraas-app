...
func set_selected_items(ids):
	for id in ids:
		selected_items.append(player_manager.get_item(id))
	pass
...
func fight():
	...
	# now, yield after confirm button is pressed
	yield(fight_base_ui.ui_confirm_button, "pressed")
